import ConsentAdvForm from "../components/form/ConsentAdvForm";
import { FadeInAnimation } from "../components/animations/Animations";
import Footer from '../components/Footer';
import IMAGES from '../assets/Images';

export interface IConsimtamantAvansatiProps {
}

export default function ConsimtamantAvansatiPage(props: IConsimtamantAvansatiProps) {
  return (
