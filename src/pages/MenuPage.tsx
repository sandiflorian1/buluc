  ...
  return (
    <FadeInAnimation>
      <MainLayout bgImg={IMAGES.bgSufragerie} noPadding>
        <div ref={serateBgRef} className="absolute top-0 bottom-0 right-0 left-0 z-[-1] serate-bg">
          <div className="bg-cover bg-no-repeat bg-center h-full w-full" style={{ backgroundImage: `url(${IMAGES.teatruBg})` }}/>
        </div>
        <div ref={teaturBgRef} className="absolute top-0 bottom-0 right-0 left-0 z-[-1] teatru-bg">
          <div className="bg-cover bg-no-repeat bg-center h-full w-full" style={{ backgroundImage: `url(${IMAGES.teatruBg})` }}/>
        </div>
