...
export default function Doact() {
  return (
    <MainLayout noPadding>
      ...
      <FadeInViewPortAnimation className="columns-4 gap-0 pb-20">
      ...
      <div className="px-[12%]">
        <ScaleViewPortAnimation className="columns-2 mb:columns-1 gap-8 mb-20">
          ...
          <div className="bg-white br p-6">
            ...
            <a href="https://www.instagram.com/zoomtalks/" target="_blank"> <p className="flex"> <FaInstagram size='20px' className="mr-2 mt-[2px]" /> Vezi pagina </p></a>
          </div>
