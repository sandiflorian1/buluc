const IMAGES = {
    ...
    sufrageria: new URL('/src/assets/images/culise/locatie/sufrageria.png', import.meta.url).href,
    sufrageria2: new URL('/src/assets/images/culise/locatie/sufrageria2.jpg' , import.meta.url).href,
    sufrageria3: new URL('/src/assets/images/culise/locatie/sufrageria3.jpg' , import.meta.url).href,
    sufrageria4: new URL('/src/assets/images/culise/locatie/sufrageria4.jpg' , import.meta.url).href,
